...
input double Risk_Money = 100.0;input int MagicStart = 6914; // Magic Number, kind of...
class c
{
		public:
	static double Risk_Money;
...
// Block 1 (Buy now)
class Block0: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_prices_LowestFromToCandles,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		VolumeSizeRisk = (double)c::Risk_Money;
		ArrowColorBuy = (color)clrBlue;
	}
};

// Block 2 (MACD Divergence (Bullish))
class Block1: public MDL_macdDivBull<string,int,int,int,double,ENUM_TIMEFRAMES>
{
...
// Block 4 (MACD Divergence (Bearish))
class Block3: public MDL_macdDivBear<string,int,int,int,double,ENUM_TIMEFRAMES>
{
...
/*<fxdreema:
:fxdreema>*/