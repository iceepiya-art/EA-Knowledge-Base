...
input bool Reverse = false;input double Lot = 0.01;input double TP = 50.0;input double SL = 50.0;input int MagicStart = 7611; // Magic Number, kind of...
class c
{
		public:
	static bool Reverse;
...
class Block1: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	Block1() {
		...
		// Block input parameters
		Group = "1";
		VolumeMode = "dalembert";
		mm1326InitialLots = 0.01;
		mmFiboInitialLots = 0.01;
	}
	...
	{
		Symbol = (string)CurrentSymbol();
		mmDalembertInitialLots = (double)c::Lot;
		mmDalembertReverse = (bool)c::Reverse;
...
/*<fxdreema:
:fxdreema>*/