...
input double Nearby_PIP = 20.0;input double TP = 10.0;input double SL = 0.0;input double Volume_upper_limit = 1.0;input double LOT_Percent_Balance = 100.0;input int MagicStart = 6153; // Magic Number, kind of...
class c
{
		public:
	...
	static double TP;
	static double SL;
	static double Volume_upper_limit;
...
{
		public:
	static double Lotbuy;
	static double Lotsell;
};
double v::Lotbuy;
double v::Lotsell;
...
int OnInit()
{
	...
	c::TP = TP;
	c::SL = SL;
	c::Volume_upper_limit = Volume_upper_limit;
...
class Block0: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	virtual void _beforeExecute_()
	{
		...
		VolumeUpperLimit = (double)c::Volume_upper_limit;
...
// Block 6 (No trade nearby)
class Block2: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 12 (Comment)
class Block5: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_account_AccountEquity,double,string,MDLIC_account_AccountFreeMargin,double,string,MDLIC_account_AccountBalance,double,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{
...
/*<fxdreema:
:fxdreema>*/