...
input double RSI_Period = 14.0;input double RSI_Buy_Level = 60.0;input double RSI_Sell_Level = 30.0;input double Lot_Percent_Balance = 100.0;input double Near_PIP = 40.0;input double Martingale = 1.2;input double Take_Profit_PIP = 5.0;input int MagicStart = 6959; // Magic Number, kind of...
class c
{
		public:
	static double RSI_Period;
	static double RSI_Buy_Level;
	static double RSI_Sell_Level;
	static double Lot_Percent_Balance;
	static double Near_PIP;
	static double Martingale;
	static double Take_Profit_PIP;
	static int MagicStart;
};
double c::RSI_Period;
double c::RSI_Buy_Level;
double c::RSI_Sell_Level;
double c::Lot_Percent_Balance;
double c::Near_PIP;
double c::Martingale;
double c::Take_Profit_PIP;
int c::MagicStart;
...
int OnInit()
{
	...
	c::RSI_Buy_Level = RSI_Buy_Level;
	c::RSI_Sell_Level = RSI_Sell_Level;
	c::Lot_Percent_Balance = Lot_Percent_Balance;
	c::Near_PIP = Near_PIP;
	c::Martingale = Martingale;
	c::Take_Profit_PIP = Take_Profit_PIP;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {2,3,6,17,24,25};
...
// Block 1 (RSI)
class Block0: public MDL_Condition<MDLIC_indicators_iRSI,double,string,MDLIC_value_value,double,int>
{
...
// Block 5 (Buy now)
class Block4: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		VolumePercent = (double)c::Lot_Percent_Balance;
		ArrowColorBuy = (color)clrBlue;
	}
};
...
// Block 9 (Condition)
class Block8: public MDL_Condition<MDLIC_candles_candles,double,string,MDLIC_inloop_OrderOpenPrice,double,int>
{
...
class Block11: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block13: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 42 (Check profit (unrealized))
class Block26: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		ProfitAmountPips = (double)c::Take_Profit_PIP;
	}
};

// Block 43 (Close trades)
...
// Block 44 (Check profit (unrealized))
...
/*<fxdreema:
:fxdreema>*/