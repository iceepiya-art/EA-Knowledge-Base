...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {0,3,48,49,56,60,68,75,86,87,92,93,103,130,131,146,153};
...
// Block 157 (Formula)
class Block100: public MDL_Formula_23<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 158 (Formula)
class Block101: public MDL_Formula_24<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 363 (Pass)
class Block103: public MDL_Pass
{
...
class Block105: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_1,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block107: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_2,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 573 (Custom MQL code)
class Block108: public MDL_CustomCode<bool>
{

	public: /* Constructor */
	Block108() {
		__block_number = 108;
		__block_user_number = "573";
		_beforeExecuteEnabled = true;
...
// Block 574 (Custom MQL code)
class Block109: public MDL_CustomCode<bool>
{

	public: /* Constructor */
	Block109() {
		__block_number = 109;
		__block_user_number = "574";
		_beforeExecuteEnabled = true;
...
class Block112: public MDL_Spreadfilter<string,string,string,double,int,double>
{
...
class Block113: public MDL_Spreadfilter<string,string,string,double,int,double>
{
...
// Block 791 (If trade)
class Block114: public MDL_IfOpenedOrders<string,string,string,string,string>
{
...
// Block 793 (Formula)
class Block116: public MDL_Formula_25<MDLIC_bucket_bucket_3,double,string,MDLIC_bucket_bucket_4,double>
{
...
// Block 794 (Formula)
class Block117: public MDL_Formula_26<MDLIC_prices_prices,double,string,MDLIC_value_points,double>
{
...
// Block 795 (Formula)
class Block118: public MDL_Formula_27<MDLIC_value_value,double,string,MDLIC_value_points,double>
{
...
class Block119: public MDL_ModifyOpened<string,string,string,string,string,int,string,MDLIC_candles_candles,double,string,double,double,MDLIC_value_value,double,double,double,MDLIC_value_value,double,color>
{
...
class Block121: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 799 (Formula)
class Block122: public MDL_Formula_28<MDLIC_bucket_bucket_5,double,string,MDLIC_bucket_bucket_6,double>
{
...
// Block 800 (Formula)
class Block123: public MDL_Formula_29<MDLIC_prices_prices,double,string,MDLIC_value_points,double>
{
...
// Block 801 (Formula)
class Block124: public MDL_Formula_30<MDLIC_value_value,double,string,MDLIC_value_points,double>
{
...
class Block125: public MDL_ModifyOpened<string,string,string,string,string,int,string,MDLIC_candles_candles,double,string,double,double,MDLIC_value_value,double,double,double,MDLIC_value_value,double,color>
{
...
class Block126: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block127: public MDL_LoopOncePer<bool>
{
...
class Block129: public MDL_LoopOncePer<bool>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[121].run(129);
		}
	}
};

// Block 807 (Check trades count)
class Block130: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
class Block131: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
class Block132: public MDL_Spreadfilter<string,string,string,double,int,double>
{
...
class Block133: public MDL_Spreadfilter<string,string,string,double,int,double>
{
...
// Block 839 (No trade)
class Block134: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 840 (No trade)
class Block135: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
class Block136: public MDL_HoursFilter<string,string,string,bool,string,string,bool,string,string,bool,string,string>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[144].run(136);
		}
	}
};

// Block 860 (Hours filter)
class Block137: public MDL_HoursFilter<string,string,string,bool,string,string,bool,string,string,bool,string,string>
{
...
class Block139: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block140: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block141: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block142: public MDL_Formula_31<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[162].run(142);
		}
	}
};

// Block 921 (Formula)
class Block143: public MDL_Formula_32<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[163].run(143);
		}
	}
};

// Block 1470 (Once per bar)
class Block144: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
...
// Block 1472 (Formula)
class Block146: public MDL_Formula_33<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
class Block147: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block148: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 1477 (Formula)
class Block149: public MDL_Formula_34<MDLIC_bucket_bucket_7,double,string,MDLIC_bucket_bucket_8,double>
{
...
class Block150: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[147].run(150);
		}
	}
};

// Block 1479 (once per trade/order)
class Block151: public MDL_LoopOncePer<bool>
{
...
// Block 1480 (close)
class Block152: public MDL_LoopClose<ulong,color>
{
...
// Block 1481 (Formula)
class Block153: public MDL_Formula_35<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[155].run(153);
		}
	}
};

// Block 1483 (For each Trade)
class Block154: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
// Block 1486 (Formula)
class Block156: public MDL_Formula_36<MDLIC_bucket_bucket_9,double,string,MDLIC_bucket_bucket_10,double>
{
...
class Block157: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[154].run(157);
		}
	}
};

// Block 1488 (once per trade/order)
class Block158: public MDL_LoopOncePer<bool>
{
...
// Block 1489 (close)
class Block159: public MDL_LoopClose<ulong,color>
{
...
class Block160: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_11,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block161: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_12,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 1492 (Buy now)
class Block162: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,int,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 1494 (Sell now)
class Block163: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,int,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
/*<fxdreema:
:fxdreema>*/