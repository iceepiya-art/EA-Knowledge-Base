...
input string symbol1 = "EURUSD";input string symbol2 = "GBPUSD";input int MagicStart = 5628; // Magic Number, kind of...
class c
{
		public:
...
class MDL_Formula_1: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::DD1 = formula(compare, lo, ro)*100;
...
class MDL_Formula_2: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::DD2 = formula(compare, lo, ro)*100;
...
class Block2: public MDL_SetCurrentSymbol2<string>
{
	...
	virtual void _beforeExecute_()
	{
		ListOfSymbols = (string)c::symbol1;
	}
};

// Block 4 (No position nearby)
class Block3: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 6 (Set \"Current Market\" for next blocks)
class Block5: public MDL_SetCurrentSymbol2<string>
{
	...
	virtual void _beforeExecute_()
	{
		ListOfSymbols = (string)c::symbol2;
	}
};

// Block 7 (Bucket of Positions)
...
// Block 8 (Bucket of Positions)
class Block7: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 9 (Formula)
class Block8: public MDL_Formula_1<MDLIC_bucket_bucket_1,double,string,MDLIC_account_AccountBalance,double>
{
...
// Block 10 (Formula)
class Block9: public MDL_Formula_2<MDLIC_bucket_bucket_2,double,string,MDLIC_account_AccountBalance,double>
{
...
// Block 12 (Comment)
class Block11: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{
	...
	virtual void _beforeExecute_()
	{
		...
		ObjLabelsFontColor = (color)clrDarkGray;
		ObjFontColor = (color)clrWhite;
		Label1 = (string)c::symbol1;
		Label2 = (string)c::symbol2;
	}
};
...
/*<fxdreema:
:fxdreema>*/