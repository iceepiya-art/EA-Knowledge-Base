...
class v
{
	...
	static double Swapbuy;
	static double Swapsell;
	static string SYMBOLX;
};
double v::USDR9;
double v::JPYR9;
double v::AUDR9;
...
// Block 394 (Set \"Current Market\" for next blocks)
...
// Block 395 (Set \"Current Market\" for next blocks)
...
// Block 396 (Set \"Current Market\" for next blocks)
...
// Block 397 (Set \"Current Market\" for next blocks)
...
// Block 398 (Set \"Current Market\" for next blocks)
...
// Block 399 (Set \"Current Market\" for next blocks)
...
// Block 400 (Set \"Current Market\" for next blocks)
...
// Block 401 (Set \"Current Market\" for next blocks)
...
// Block 402 (Set \"Current Market\" for next blocks)
...
// Block 403 (Set \"Current Market\" for next blocks)
...
// Block 404 (Set \"Current Market\" for next blocks)
...
// Block 405 (Set \"Current Market\" for next blocks)
...
// Block 406 (Set \"Current Market\" for next blocks)
...
// Block 407 (Set \"Current Market\" for next blocks)
...
// Block 408 (Set \"Current Market\" for next blocks)
...
// Block 409 (Set \"Current Market\" for next blocks)
...
// Block 410 (Set \"Current Market\" for next blocks)
...
// Block 411 (Set \"Current Market\" for next blocks)
...
// Block 412 (Set \"Current Market\" for next blocks)
...
// Block 413 (Set \"Current Market\" for next blocks)
...
// Block 414 (Set \"Current Market\" for next blocks)
...
// Block 415 (Set \"Current Market\" for next blocks)
...
// Block 416 (Set \"Current Market\" for next blocks)
...
// Block 417 (Set \"Current Market\" for next blocks)
...
// Block 418 (Set \"Current Market\" for next blocks)
...
// Block 419 (Set \"Current Market\" for next blocks)
...
// Block 420 (Set \"Current Market\" for next blocks)
...
// Block 421 (Set \"Current Market\" for next blocks)
...
// Block 422 (Set \"Current Market\" for next blocks)
...
// Block 423 (Set \"Current Market\" for next blocks)
...
// Block 424 (Set \"Current Market\" for next blocks)
...
// Block 425 (Set \"Current Market\" for next blocks)
...
// Block 426 (Set \"Current Market\" for next blocks)
...
// Block 427 (Set \"Current Market\" for next blocks)
...
// Block 428 (Set \"Current Market\" for next blocks)
...
// Block 429 (Set \"Current Market\" for next blocks)
...
// Block 430 (Set \"Current Market\" for next blocks)
...
// Block 431 (Set \"Current Market\" for next blocks)
...
// Block 432 (Set \"Current Market\" for next blocks)
...
// Block 433 (Set \"Current Market\" for next blocks)
...
// Block 434 (Set \"Current Market\" for next blocks)
...
// Block 435 (Set \"Current Market\" for next blocks)
...
// Block 436 (Set \"Current Market\" for next blocks)
...
// Block 437 (Set \"Current Market\" for next blocks)
...
// Block 438 (Set \"Current Market\" for next blocks)
...
// Block 439 (Set \"Current Market\" for next blocks)
...
// Block 440 (Set \"Current Market\" for next blocks)
...
// Block 441 (Set \"Current Market\" for next blocks)
...
// Block 442 (Set \"Current Market\" for next blocks)
...
// Block 443 (Set \"Current Market\" for next blocks)
...
// Block 444 (Set \"Current Market\" for next blocks)
...
// Block 445 (Set \"Current Market\" for next blocks)
...
// Block 446 (Set \"Current Market\" for next blocks)
...
// Block 447 (Buy now)
class Block426: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_candles_candles,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 448 (Sell now)
class Block427: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_candles_candles,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 451 (Set \"Current Market\" for next blocks)
...
// Block 452 (Set \"Current Market\" for next blocks)
...
// Block 453 (Set \"Current Market\" for next blocks)
...
// Block 469 (If position)
class Block445: public MDL_IfOpenedOrders<string,string,string,string,string>
{
...
// Block 470 (Check profit (unrealized))
class Block446: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 471 (Formula)
class Block447: public MDL_Formula_1<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[446].run(447);
		}
	}
};

// Block 472 (Close positions)
class Block448: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 488 (Condition)
class Block449: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{

	public: /* Constructor */
	Block449() {
		__block_number = 449;
		__block_user_number = "488";
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[427].run(449);
		}
	}
};

// Block 490 (Condition)
class Block450: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{

	public: /* Constructor */
	Block450() {
		__block_number = 450;
		__block_user_number = "490";
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[426].run(450);
		}
	}
};

// Block 491 (No position nearby)
class Block451: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block451() {
		__block_number = 451;
		__block_user_number = "491";
		_beforeExecuteEnabled = true;

		// Fill the list of outbound blocks
		int ___outbound_blocks[1] = {455};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		BuysOrSells = "sells";
	}
...
// Block 492 (No position nearby)
class Block452: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{

	public: /* Constructor */
	Block452() {
		__block_number = 452;
		__block_user_number = "492";
		_beforeExecuteEnabled = true;

		// Fill the list of outbound blocks
		int ___outbound_blocks[1] = {456};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		BuysOrSells = "buys";
	}
...
// Block 494 (Custom MQL code)
class Block453: public MDL_CustomCode<bool>
{

	public: /* Constructor */
	Block453() {
		__block_number = 453;
		__block_user_number = "494";
		_beforeExecuteEnabled = true;
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[449].run(453);
		}
	}

	virtual void _beforeExecute_()
	{
		v::Swapsell=SymbolInfoDouble(v::SYMBOLX,SYMBOL_SWAP_SHORT);
	}
};

// Block 495 (Custom MQL code)
class Block454: public MDL_CustomCode<bool>
{

	public: /* Constructor */
	Block454() {
		__block_number = 454;
		__block_user_number = "495";
		_beforeExecuteEnabled = true;
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[450].run(454);
		}
	}

	virtual void _beforeExecute_()
	{
		v::Swapbuy=SymbolInfoDouble(v::SYMBOLX,SYMBOL_SWAP_LONG);
	}
};

// Block 497 (Modify Variables)
class Block455: public MDL_ModifyVariables<int,MDLIC_market_Symbol,string,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{

	public: /* Constructor */
	Block455() {
		__block_number = 455;
		__block_user_number = "497";
		_beforeExecuteEnabled = true;
...
// Block 498 (Modify Variables)
class Block456: public MDL_ModifyVariables<int,MDLIC_market_Symbol,string,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{

	public: /* Constructor */
	Block456() {
		__block_number = 456;
		__block_user_number = "498";
		_beforeExecuteEnabled = true;
...
/*<fxdreema:
:fxdreema>*/