...
agent_dir = r"G:\My Drive\save log-blueprint-skill\EA-Knowledge-Base\ea_research_team\MT5_Agents\Agent_3"
...
for rule_id in rules:
    ...
    if os.path.exists(final_report):
        print(f"Agent 3 Skipping Rule {rule_id} (already tested)")
        continue
...
'''
    ...
    print(f"Agent 3 Testing Rule {rule_id}...")
