...
input string Currency1 = "EURUSD";input string Currency2 = "GBPUSD";input string Currency3 = "EURGBP";input double LOT = 100.0;input double Profit_percent = 0.1;input double Martingale = 1.5;input double Near = 40.0;input double Triger = 0.001;input int MagicStart = 5523; // Magic Number, kind of...
class c
{
		public:
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {3,8,16,17,38,40,46,47,48,52,59,66,70,74,78,87};
	for (int i=0; i<ArraySize(blocks_to_run); i++) {
		_blocks_[blocks_to_run[i]].run();
	}
...
// "Orders and Trades limit" model
class MDLIC_account_AccountPendingOrdersLimit
{
	public: /* Input Parameters */
	virtual void _callback_(int r) {return;}

	public: /* Constructor */
	MDLIC_account_AccountPendingOrdersLimit()
	{
	}
...
class Block0: public MDL_NoOpenedOrders<string,string,string,string,string>
{
	...
	Block0() {
		...
		int ___outbound_blocks[3] = {1,2,53};
...
// Block 24 (Buy now)
class Block1: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 28 (Check profit (unrealized))
...
// Block 29 (Close positions)
class Block5: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
class Block6: public MDL_NoOpenedOrders<string,string,string,string,string>
{
	...
	Block6() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {11,56,7};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "2";
		SymbolMode = "all";
...
// Block 32 (Buy now)
class Block7: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 35 (Check profit (unrealized))
...
// Block 36 (Close positions)
class Block10: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 42 (Buy now)
class Block12: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 50 (Buy now)
class Block14: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 57 (Sell now)
class Block15: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
class Block16: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block16() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {18,20,22};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "1";
		SymbolMode = "all";
...
class Block17: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block17() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {27,29,31};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "2";
		SymbolMode = "all";
...
// Block 63 (Condition)
class Block21: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
// Block 65 (Condition)
class Block23: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
class Block24: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block24() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {12,13,54};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "1";
		BuysOrSells = "buys";
...
// Block 70 (Condition)
class Block28: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
// Block 72 (Condition)
class Block30: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
// Block 73 (For each Position)
class Block31: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
// Block 74 (Condition)
class Block32: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
// Block 75 (No position nearby)
class Block33: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block33() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {14,15,55};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "2";
		BuysOrSells = "sells";
...
// Block 76 (No position nearby)
class Block34: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
class Block35: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 123 (Formula)
class Block36: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 124 (Formula)
class Block37: public MDL_Formula_2<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 136 (Bucket of Trades)
class Block38: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block39: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_1,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 138 (Bucket of Trades)
class Block40: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 139 (Modify Variables)
class Block41: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_2,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 142 (Custom MQL code)
class Block42: public MDL_CustomCode<bool>
{
...
// Block 144 (Formula)
class Block44: public MDL_Formula_3<MDLIC_value_value,double,string,MDLIC_account_AccountBalance,double>
{
...
// Block 145 (Formula)
class Block45: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_account_AccountBalance,double>
{
...
// Block 162 (Formula)
class Block46: public MDL_Formula_5<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 163 (Formula)
class Block47: public MDL_Formula_6<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 164 (Formula)
class Block48: public MDL_Formula_7<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 165 (Formula)
class Block49: public MDL_Formula_8<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 166 (Formula)
class Block50: public MDL_Formula_9<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 167 (Formula)
class Block51: public MDL_Formula_10<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 170 (Sell now)
class Block54: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 171 (Buy now)
class Block55: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 172 (Buy now)
class Block56: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 182 (For each Position)
class Block62: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block63: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 184 (For each Position)
class Block64: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block65: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 1912 (For each Object)
class Block66: public MDL_ObjLoopStart<long,int,ENUM_OBJECT,int,int,color,string,string,string,int,int>
{

	public: /* Constructor */
	Block66() {
		__block_number = 66;
		__block_user_number = "1912";
		_beforeExecuteEnabled = true;
...
// Block 1913 (Select Object by Name)
class Block67: public MDL_ObjLoopSelectByName<string>
{

	public: /* Constructor */
	Block67() {
		__block_number = 67;
		__block_user_number = "1913";
...
// Block 1914 (check button state)
class Block68: public MDL_ObjLoopCheckButton<bool>
{

	public: /* Constructor */
	Block68() {
		__block_number = 68;
		__block_user_number = "1914";
...
// Block 1915 (Counter: Pass once)
class Block69: public MDL_PassOnce<int>
{

	public: /* Constructor */
	Block69() {
		__block_number = 69;
		__block_user_number = "1915";


		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {0,82};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		CounterID = 4;
	}
...
// Block 1916 (For each Object)
class Block70: public MDL_ObjLoopStart<long,int,ENUM_OBJECT,int,int,color,string,string,string,int,int>
{

	public: /* Constructor */
	Block70() {
		__block_number = 70;
		__block_user_number = "1916";
		_beforeExecuteEnabled = true;
...
// Block 1917 (Select Object by Name)
class Block71: public MDL_ObjLoopSelectByName<string>
{

	public: /* Constructor */
	Block71() {
		__block_number = 71;
		__block_user_number = "1917";
...
// Block 1918 (check button state)
class Block72: public MDL_ObjLoopCheckButton<bool>
{

	public: /* Constructor */
	Block72() {
		__block_number = 72;
		__block_user_number = "1918";
...
// Block 1919 (Counter: Reset)
class Block73: public MDL_CounterReset<string>
{

	public: /* Constructor */
	Block73() {
		__block_number = 73;
		__block_user_number = "1919";
...
// Block 1920 (For each Object)
class Block74: public MDL_ObjLoopStart<long,int,ENUM_OBJECT,int,int,color,string,string,string,int,int>
{

	public: /* Constructor */
	Block74() {
		__block_number = 74;
		__block_user_number = "1920";
		_beforeExecuteEnabled = true;
...
// Block 1921 (Select Object by Name)
class Block75: public MDL_ObjLoopSelectByName<string>
{

	public: /* Constructor */
	Block75() {
		__block_number = 75;
		__block_user_number = "1921";
...
// Block 1922 (check button state)
class Block76: public MDL_ObjLoopCheckButton<bool>
{

	public: /* Constructor */
	Block76() {
		__block_number = 76;
		__block_user_number = "1922";
...
// Block 1923 (Counter: Pass once)
class Block77: public MDL_PassOnce<int>
{

	public: /* Constructor */
	Block77() {
		__block_number = 77;
		__block_user_number = "1923";


		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {6,83};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		CounterID = 5;
	}
...
// Block 1924 (For each Object)
class Block78: public MDL_ObjLoopStart<long,int,ENUM_OBJECT,int,int,color,string,string,string,int,int>
{

	public: /* Constructor */
	Block78() {
		__block_number = 78;
		__block_user_number = "1924";
		_beforeExecuteEnabled = true;
...
// Block 1925 (Select Object by Name)
class Block79: public MDL_ObjLoopSelectByName<string>
{

	public: /* Constructor */
	Block79() {
		__block_number = 79;
		__block_user_number = "1925";
...
// Block 1926 (check button state)
class Block80: public MDL_ObjLoopCheckButton<bool>
{

	public: /* Constructor */
	Block80() {
		__block_number = 80;
		__block_user_number = "1926";
...
// Block 1927 (Counter: Reset)
class Block81: public MDL_CounterReset<string>
{

	public: /* Constructor */
	Block81() {
		__block_number = 81;
		__block_user_number = "1927";
...
// Block 1928 (Play sound)
class Block82: public MDL_PlaySound<string,string>
{

	public: /* Constructor */
	Block82() {
		__block_number = 82;
		__block_user_number = "1928";
...
// Block 1929 (Play sound)
class Block83: public MDL_PlaySound<string,string>
{

	public: /* Constructor */
	Block83() {
		__block_number = 83;
		__block_user_number = "1929";
...
// Block 1930 (Pass)
class Block84: public MDL_Pass
{

	public: /* Constructor */
	Block84() {
		__block_number = 84;
		__block_user_number = "1930";


		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {85,86};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 1931 (Draw Button)
class Block85: public MDL_ChartDrawButton<bool,bool,string,int,int,MDLIC_text_text,string,string,int,int,int,color,color,int,bool,color,bool,bool,bool,bool,int,string>
{

	public: /* Constructor */
	Block85() {
		__block_number = 85;
		__block_user_number = "1931";
		_beforeExecuteEnabled = true;
...
// Block 1932 (Draw Button)
class Block86: public MDL_ChartDrawButton<bool,bool,string,int,int,MDLIC_text_text,string,string,int,int,int,color,color,int,bool,color,bool,bool,bool,bool,int,string>
{

	public: /* Constructor */
	Block86() {
		__block_number = 86;
		__block_user_number = "1932";
		_beforeExecuteEnabled = true;
...
// Block 1933 (Pass)
class Block87: public MDL_Pass
{

	public: /* Constructor */
	Block87() {
		__block_number = 87;
		__block_user_number = "1933";
...
// Block 1934 (Comment)
class Block88: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_account_AccountPendingOrdersLimit,int,string,MDLIC_bucket_bucket_3,double,string,MDLIC_account_AccountProfit,double,string,MDLIC_account_AccountBalance,double,string,MDLIC_account_AccountEquity,double,string,MDLIC_objectattributes_OBJECT,double,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{

	public: /* Constructor */
	Block88() {
		__block_number = 88;
		__block_user_number = "1934";
		_beforeExecuteEnabled = true;
		...
		Value8.Text = "";
		// Block input parameters
		Title = "JOBOT Arbitrage GAME";
		ObjTitleFontSize = 15;
		ObjLabelsFontSize = 15;
		ObjFontSize = 15;
		Label3 = "Profit All";
		Label4 = "Balance";
		Label5 = "Equity";
	...
	virtual void _beforeExecute_()
	{
		...
		ObjY = 24;
		ObjCorner = (int)CORNER_RIGHT_UPPER;
		ObjTitleFontColor = (color)clrYellow;
		ObjLabelsFontColor = (color)clrLightCyan;
		ObjFontColor = (color)clrWhite;
	}
};
...
/*<fxdreema:
:fxdreema>*/