...
// "Random outputs" model
class MDL_RandomOutputs: public BlockCalls
{
	virtual void _callback_(int r) {return;}
	...
	virtual void _execute_()
	{
		MathSrand((int)(GetTickCount()/SymbolInfoDouble(Symbol(), SYMBOL_ASK)));
		
		if (MathRand()%2 > 0) {_callback_(1);} else {_callback_(0);}
	}
};
...
// Block 5 (Random outputs)
class Block4: public MDL_RandomOutputs
{
	...
	Block4() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[6] = {1,2,3,5,6,7};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 7 (Sell now)
class Block6: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
class Block8: public MDL_BucketSelectClosed<color,string,string,string,string,string,bool,MDLIC_value_time,datetime,bool,MDLIC_value_time,datetime,int>
{
...
// Block 10 (Condition)
class Block9: public MDL_Condition<MDLIC_bucket_bucket_1,double,string,MDLIC_value_value,double,int>
{
...
// Block 11 (Formula)
class Block10: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block12: public MDL_PassOnce<int>
{
...
// Block 15 (Formula)
class Block13: public MDL_Formula_3<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/