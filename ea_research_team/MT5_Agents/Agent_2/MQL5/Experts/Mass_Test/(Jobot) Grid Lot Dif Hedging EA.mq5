...
input double Lot = 100.0;input double NEAR = 20.0;input double TP = 10.0;input double SL = 0.0;input double Profit_Percent = 1.0;input double Cut_Loss_Percent = 100.0;input bool Balance_Update_on_off = true;input ENUM_TIMEFRAMES Balance_Update = PERIOD_D1;input string comment = "Jobot";input int MagicStart = 7277; // Magic Number, kind of...
class c
{
		public:
	static double Lot;
	...
	static bool Balance_Update_on_off;
	static ENUM_TIMEFRAMES Balance_Update;
...
bool c::Balance_Update_on_off;
ENUM_TIMEFRAMES c::Balance_Update;
string c::comment;
int c::MagicStart;
...
class v
{
	...
	static double LOTB;
	static double LOTS;
	static double Balance_Start;
	static double Profitx;
	static double Cut_lossx;
};
double v::LOTB;
double v::LOTS;
double v::Balance_Start;
double v::Profitx;
double v::Cut_lossx;
...
int OnInit()
{
	...
	c::Balance_Update_on_off = Balance_Update_on_off;
	c::Balance_Update = Balance_Update;
	c::comment = comment;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {1,2,7,8,13,20,24,25};
...
class MDL_Formula_1: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::LOTB = formula(compare, lo, ro)/10000000;
...
class MDL_Formula_2: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::LOTS = formula(compare, lo, ro)/10000000;
...
class MDL_Formula_3: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::Balance_Start = formula(compare, lo, ro);
...
class MDL_Formula_5: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::Profitx = formula(compare, lo, ro)/100;
...
// Block 2 (Bucket of Positions)
class Block0: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 4 (Check positions count)
class Block1: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
// Block 6 (Formula)
class Block3: public MDL_Formula_1<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 7 (No position nearby)
class Block4: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 9 (Bucket of Positions)
class Block6: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 11 (Check positions count)
class Block7: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
// Block 12 (Check positions count)
...
// Block 16 (Modify Variables)
class Block12: public MDL_ModifyVariables<int,MDLIC_account_AccountBalance,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 18 (Condition)
class Block14: public MDL_Condition<MDLIC_account_AccountEquity,double,string,MDLIC_value_value,double,int>
{
...
// Block 19 (Formula)
class Block15: public MDL_Formula_3<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 22 (Formula)
class Block17: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 25 (Formula)
class Block18: public MDL_Formula_5<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 26 (Formula)
class Block19: public MDL_Formula_6<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 28 (Formula)
class Block21: public MDL_Formula_7<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 29 (Check profit (unrealized))
...
// Block 42 (Once per bar)
class Block24: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		Period = (ENUM_TIMEFRAMES)c::Balance_Update;
	}
};

// Block 43 (Counter: Pass once)
class Block25: public MDL_PassOnce<int>
{
...
class Block26: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
	...
	public: /* Custom methods */
	virtual bool _Lo_() {
		Lo.Boolean = c::Balance_Update_on_off;
...
// Block 53 (Bucket of Positions)
class Block27: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 55 (Formula)
class Block29: public MDL_Formula_8<MDLIC_bucket_bucket_1,double,string,MDLIC_bucket_bucket_2,double>
{
...
// Block 56 (Formula)
class Block30: public MDL_Formula_9<MDLIC_bucket_bucket_3,double,string,MDLIC_bucket_bucket_4,double>
{
...
// Block 57 (Sell &gt; Buy)
class Block31: public MDL_Condition<MDLIC_bucket_bucket_5,double,string,MDLIC_bucket_bucket_6,double,int>
{
...
// Block 58 (Sell &lt; Buy)
class Block32: public MDL_Condition<MDLIC_bucket_bucket_7,double,string,MDLIC_bucket_bucket_8,double,int>
{
...
// Block 59 (Sell &gt; Buy)
class Block33: public MDL_Condition<MDLIC_bucket_bucket_9,double,string,MDLIC_bucket_bucket_10,double,int>
{
...
// Block 60 (Sell &lt; Buy)
class Block34: public MDL_Condition<MDLIC_bucket_bucket_11,double,string,MDLIC_bucket_bucket_12,double,int>
{
...
/*<fxdreema:
:fxdreema>*/