...
input string Symbol1 = "EURUSD";input string Symbol2 = "GBPUSD";input string Symbol3 = "EURGBP";input double LOT_Divided = 1000000.0;input double TP = 50.0;input double SL = 50.0;input double Martingale = 2.0;input int MagicStart = 4433; // Magic Number, kind of...
class c
{
		public:
...
// Block 9 (Bucket of Closed Positions)
class Block7: public MDL_BucketSelectClosed<color,string,string,string,string,string,bool,MDLIC_value_time,datetime,bool,MDLIC_value_time,datetime,int>
{
...
// Block 10 (Condition)
class Block8: public MDL_Condition<MDLIC_bucket_bucket_1,double,string,MDLIC_value_value,double,int>
{
...
// Block 11 (Formula)
class Block9: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block11: public MDL_PassOnce<int>
{
	...
	Block11() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {12,18};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 15 (Formula)
class Block12: public MDL_Formula_3<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 16 (No position)
class Block13: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 24 (Bucket of Closed Positions)
class Block14: public MDL_BucketSelectClosed<color,string,string,string,string,string,bool,MDLIC_value_time,datetime,bool,MDLIC_value_time,datetime,int>
{
	...
	Block14() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {15,17};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
...
// Block 25 (Condition)
class Block15: public MDL_Condition<MDLIC_bucket_bucket_2,double,string,MDLIC_value_value,double,int>
{
...
class Block16: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
	...
	Block16() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {4,5,6};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		compare = "*";
	}
...
// Block 28 (Formula)
class Block17: public MDL_Formula_5<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 29 (Formula)
class Block18: public MDL_Formula_6<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/