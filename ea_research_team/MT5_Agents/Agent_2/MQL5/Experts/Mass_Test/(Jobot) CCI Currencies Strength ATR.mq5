...
class Block1: public MDL_WeekdayFilter<string,bool,bool,bool,bool,bool,bool,bool>
{
	...
	Block1() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[14] = {257,259,261,289,290,331,332,349,350,361,362,365,366,372};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
class Block2: public MDL_WeekdayFilter<string,bool,bool,bool,bool,bool,bool,bool>
{
	...
	Block2() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[14] = {261,263,265,285,286,291,292,293,294,347,348,359,360,372};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
class Block23: public MDL_CustomCode<bool>
{
	...
	Block23() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {18,367,368};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 436 (Comment)
class Block367: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{
	...
	Block367() {
		...
		// IC input parameters
		Value1.Text = "jakka.robot@gmail.com";
		Value2.Text = "+66909496535";
		Value3.Text = "JAKKARIN CHINSUWAN";
		Value4.Text = "";
		Value5.Text = "";
		Value6.Text = "";
		// Block input parameters
		Title = "(Jobot) CCI Currencies Strength ATR";
		ObjTitleFontSize = 20;
		Label1 = "Email";
		Label2 = "Tel.";
		Label3 = "OWNER";
	...
	virtual string _Value7_() {
		Value7.Text = v::MAIN_BUY;

		return Value7._execute_();
	}
	virtual string _Value8_() {
		Value8.Text = v::MAIN_SELL;
	...
	virtual void _beforeExecute_()
	{
		...
		ObjTitleFontColor = (color)clrTurquoise;
		ObjLabelsFontColor = (color)clrDarkGray;
		ObjFontColor = (color)clrWhite;
	}
};
...
// Block 456 (Comment)
class Block371: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block372: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[373].run(372);
		}
	}
};

// Block 478 (GBP S)
class Block373: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
class Block425: public MDL_SetCurrentSymbol2<string>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[430].run(425);
		}
	}
};

// Block 1007 (Set \"Current Market\" for next blocks)
class Block426: public MDL_SetCurrentSymbol2<string>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[430].run(426);
		}
	}
};

// Block 1008 (Buy now)
class Block427: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_prices_LowestFromToCandles,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 1013 (Pass)
class Block430: public MDL_Pass
{
...
class Block432: public MDL_SetCurrentSymbol2<string>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[435].run(432);
		}
	}
};

// Block 1016 (Set \"Current Market\" for next blocks)
class Block433: public MDL_SetCurrentSymbol2<string>
{
...
class Block444: public MDL_Pass
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[451].run(444);
		}
	}
};

// Block 1030 (Pass)
class Block445: public MDL_Pass
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[453].run(445);
		}
	}
};

// Block 1033 (No position nearby)
class Block446: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
class Block447: public MDL_IfOpenedOrders<string,string,string,string,string>
{
...
class Block448: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 1037 (Formula)
class Block449: public MDL_Formula_1<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[448].run(449);
		}
	}
};

// Block 1038 (Close positions)
class Block450: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 1039 (Formula)
class Block451: public MDL_Formula_2<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
// Block 1046 (Formula)
class Block453: public MDL_Formula_3<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[452].run(453);
		}
	}
};

// Block 1047 (Pass)
class Block454: public MDL_Pass
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[455].run(454);
		}
	}
};

// Block 1048 (Formula)
class Block455: public MDL_Formula_4<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/