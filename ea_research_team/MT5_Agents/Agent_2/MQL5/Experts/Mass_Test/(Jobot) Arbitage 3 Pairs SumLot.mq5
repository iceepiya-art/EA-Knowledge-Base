...
input double Lot = 0.01;input double NEAR_PIP = 40.0;input double PercentProfit = 0.01;input string Symbol1 = "EURUSD";input string Symbol2 = "GBPUSD";input string Symbol3 = "EURGBP";input int MagicStart = 9705; // Magic Number, kind of...
class c
{
		public:
	static double Lot;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {4,6,9,11,14,17};
...
class Block6: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block6() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {0,2,3};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "1";
		SymbolMode = "all";
...
class Block9: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block9() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {13,7,8};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "2";
		SymbolMode = "all";
...
class Block15: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_1,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 37 (Bucket of Positions)
class Block17: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block18: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_2,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/