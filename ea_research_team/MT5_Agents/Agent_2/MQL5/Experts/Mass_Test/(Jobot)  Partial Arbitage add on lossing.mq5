...
input double Lot_percent = 100.0;input double NEAR_PIP = 40.0;input double PercentProfit = 0.01;input string Symbol1 = "EURUSD";input string Symbol2 = "GBPUSD";input string Symbol3 = "EURGBP";input int MagicStart = 9705; // Magic Number, kind of...
class c
{
		public:
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {4,6,10,13,14,15,16,17};
...
class Block17: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 120 (Check profit (unrealized))
class Block18: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 121 (Check profit (unrealized))
class Block19: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 122 (Check profit (unrealized))
...
// Block 123 (Check profit (unrealized))
...
// Block 124 (Check profit (unrealized))
...
// Block 125 (Check profit (unrealized))
...
/*<fxdreema:
:fxdreema>*/