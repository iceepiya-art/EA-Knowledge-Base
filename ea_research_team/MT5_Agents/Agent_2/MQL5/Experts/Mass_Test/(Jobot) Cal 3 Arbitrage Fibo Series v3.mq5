...
input string Currency1 = "EURUSD";input string Currency2 = "GBPUSD";input string Currency3 = "EURGBP";input double LOT_initial = 0.01;input double Profit_percent = 0.05;input double Martingale = 1.5;input double ATR_Period = 14.0;input double ATR_Multiplier = 2.0;input ENUM_TIMEFRAMES ATR_Time_Frame = PERIOD_M15;input double Triger_too_high = 1.0001;input double Triger_too_low = 0.9999;input double Trailing_Start_percent = 1.0;input double Trailing_Step_percent = 0.1;input double Trailing_Stop_percent = 0.5;input string Comment_A = "Set A";input string Comment_B = "Set B";input int MagicStart = 5523; // Magic Number, kind of...
class c
{
		public:
...
class v
{
	...
	static double step;
	static double stop;
	static double LOT1_new;
	static double LOT1_old;
	static double LOT2_new;
	static double LOT2_old;
};
double v::xyz;
double v::x1;
double v::x2;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {1,5,8,9,29,31,32};
...
class Block1: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block1() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {20,52};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "11,12,13";
		SymbolMode = "all";
...
class Block5: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block5() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {21,56};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "21,22,23";
		SymbolMode = "all";
...
class Block8: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block8() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {10,12,36};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "11,12,13";
		SymbolMode = "all";
...
class Block9: public MDL_IfOpenedOrders<string,string,string,string,string>
{
	...
	Block9() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {16,18,40};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "21,22,23";
		SymbolMode = "all";
...
class Block14: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block14() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {23,35,84};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "13";
		BuysOrSells = "sells";
...
// Block 45 (Formula)
class Block20: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_account_AccountBalance,double>
{
...
// Block 46 (Formula)
class Block21: public MDL_Formula_2<MDLIC_value_value,double,string,MDLIC_account_AccountBalance,double>
{
...
class Block22: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	{
		Symbol = (string)c::Currency2;
		VolumeSize = (double)c::LOT_initial;
		VolumePercent = (double)c::LOT_initial;
		mmFiboInitialLots = (double)c::LOT_initial;
...
class Block23: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	virtual void _beforeExecute_()
	{
		...
		VolumePercent = (double)c::LOT_initial;
		mmMgInitialLots = (double)c::LOT_initial;
...
// Block 49 (Buy now)
class Block24: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 50 (Buy now)
class Block25: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
class Block26: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
	...
	Block26() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {0,59,60};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
class Block27: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
	...
	Block27() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {4,61,62};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 57 (Comment)
class Block28: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_text_text,string,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{
...
class Block29: public MDL_ModifyVariables<int,MDLIC_prices_prices,double,int,MDLIC_prices_prices,double,int,MDLIC_prices_prices,double,int,MDLIC_prices_prices,double,int,MDLIC_value_value,double>
{
...
class Block30: public MDL_CustomCode<bool>
{
...
// Block 63 (Sell now)
class Block34: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 64 (Buy now)
class Block35: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 66 (Condition)
class Block37: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
class Block38: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 68 (Sell now)
class Block39: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
class Block40: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
// Block 70 (Condition)
class Block41: public MDL_Condition<MDLIC_inloop_OrderOpenPrice,double,string,MDLIC_candles_candles,double,int>
{
...
// Block 74 (Formula)
class Block42: public MDL_Formula_3<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
// Block 75 (Formula)
class Block43: public MDL_Formula_4<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
// Block 76 (Formula)
class Block44: public MDL_Formula_5<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
class Block45: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
	...
	Block45() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {24,39,83};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "23";
		BuysOrSells = "buys";
...
class Block46: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
class Block47: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 126 (Formula)
class Block48: public MDL_Formula_6<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
// Block 127 (Formula)
class Block49: public MDL_Formula_7<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
// Block 128 (Formula)
class Block50: public MDL_Formula_8<MDLIC_indicators_iATR,double,string,MDLIC_value_value,double>
{
...
class Block51: public MDL_TrailingMoneyLoss<string,string,string,string,string,string,double,double,MDLIC_value_value,double,string,double,double,string,double,double,MDLIC_value_value,double,ulong,color>
{
...
// Block 130 (Formula)
class Block52: public MDL_Formula_9<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 131 (Formula)
class Block53: public MDL_Formula_10<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 132 (Formula)
class Block54: public MDL_Formula_11<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
class Block55: public MDL_TrailingMoneyLoss<string,string,string,string,string,string,double,double,MDLIC_value_value,double,string,double,double,string,double,double,MDLIC_value_value,double,ulong,color>
{
...
// Block 134 (Formula)
class Block56: public MDL_Formula_12<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 135 (Formula)
class Block57: public MDL_Formula_13<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 136 (Formula)
class Block58: public MDL_Formula_14<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 141 (For each Position)
class Block63: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block64: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 143 (For each Position)
class Block65: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
	...
	Block65() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {66,79};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "11";
		BuysOrSells = "buys";
...
class Block66: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 145 (Formula)
class Block67: public MDL_Formula_15<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 148 (Modify Variables)
class Block69: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 149 (For each Position)
class Block70: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
	...
	Block70() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {71,80};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "21";
		BuysOrSells = "sells";
...
// Block 150 (Modify Variables)
class Block71: public MDL_ModifyVariables<int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 151 (Formula)
class Block72: public MDL_Formula_16<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 153 (Position closed)
class Block73: public MDL_eTrade_TradeClosed<string,string,string,string,string,string,int>
{
...
// Block 155 (Position closed)
class Block75: public MDL_eTrade_TradeClosed<string,string,string,string,string,string,int>
{
...
// Block 157 (Position created)
class Block77: public MDL_eTrade_TradeNew<string,string,string,string,string>
{
	...
	Block77() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {63,65};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "11";
		BuysOrSells = "buys";
...
// Block 158 (Position created)
class Block78: public MDL_eTrade_TradeNew<string,string,string,string,string>
{
...
// Block 162 (Buy now)
class Block82: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 163 (Buy now)
class Block83: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
/*<fxdreema:
:fxdreema>*/