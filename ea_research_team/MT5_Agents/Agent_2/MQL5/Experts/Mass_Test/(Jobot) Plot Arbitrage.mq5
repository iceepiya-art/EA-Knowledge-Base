...
input string Symbol1 = "AUDCHF";input string Symbol2 = "USDCHF";input string Symbol3 = "AUDUSD";input double Graph_level100 = 0.701;input double Graph_level0 = 0.7;input double Graph_Adjust = 0.7;input color SBB = Blue;input color BSS = Lime;input int MagicStart = 6558; // Magic Number, kind of...
class c
{
		public:
...
class v
{
	...
	static double SBBx;
	static double BSSx;
	static double PlotSBB;
	static double PlotBSS;
	static double SBBy;
	static double BSSy;
};
double v::S1;
...
class MDL_Formula_1: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::PlotSBB = formula(compare, lo, ro);
...
class MDL_Formula_9: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::PlotBSS = formula(compare, lo, ro);
...
// Block 2 (Formula)
class Block0: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 4 (Log message)
class Block2: public MDL_PrintMessage<string>
{
...
class Block4: public MDL_ChartSetColors<color,color,color,color,color,color,color,color,color,color,color,color,color>
{
...
// Block 8 (Draw Text)
class Block5: public MDL_ChartDrawText<bool,bool,string,ENUM_OBJECT,MDLIC_value_time,datetime,MDLIC_value_value,double,int,int,MDLIC_text_text,string,string,int,double,ENUM_BASE_CORNER,int,color,bool,bool,bool,bool,int,string>
{
...
// Block 11 (Formula)
class Block7: public MDL_Formula_2<MDLIC_value_value,double,string,MDLIC_market_point,double>
{
...
// Block 12 (Draw Text)
class Block8: public MDL_ChartDrawText<bool,bool,string,ENUM_OBJECT,MDLIC_value_time,datetime,MDLIC_candles_candles,double,int,int,MDLIC_text_text,string,string,int,double,ENUM_BASE_CORNER,int,color,bool,bool,bool,bool,int,string>
{
...
// Block 14 (Counter: Pass once)
class Block9: public MDL_PassOnce<int>
{
...
class Block10: public MDL_ModifyVariables<int,MDLIC_prices_prices,double,int,MDLIC_prices_prices,double,int,MDLIC_prices_prices,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 16 (Formula)
class Block11: public MDL_Formula_3<MDLIC_value_value,double,string,MDLIC_prices_prices,double>
{
...
// Block 17 (Formula)
class Block12: public MDL_Formula_4<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 18 (Formula)
class Block13: public MDL_Formula_5<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 19 (Formula)
class Block14: public MDL_Formula_6<MDLIC_prices_prices,double,string,MDLIC_value_value,double>
{
...
// Block 20 (Formula)
class Block15: public MDL_Formula_7<MDLIC_value_value,double,string,MDLIC_prices_prices,double>
{
...
// Block 21 (Formula)
class Block16: public MDL_Formula_8<MDLIC_value_value,double,string,MDLIC_prices_prices,double>
{
...
class Block17: public MDL_CustomCode<bool>
{
	...
	virtual void _beforeExecute_()
	{
		v::BSSy = v::S21 + v::S22 + v::S23 ;
	}
};

// Block 23 (Custom MQL code)
class Block18: public MDL_CustomCode<bool>
{
	...
	virtual void _beforeExecute_()
	{
		v::SBBy = v::S11 + v::S12 + v::S13 ;
	}
};

// Block 24 (Formula)
class Block19: public MDL_Formula_9<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block20: public MDL_PrintMessage<string>
{
	...
	virtual void _beforeExecute_()
	{
		PrintText = (string)v::BSSx;
	}
};

// Block 26 (Draw Text)
class Block21: public MDL_ChartDrawText<bool,bool,string,ENUM_OBJECT,MDLIC_value_time,datetime,MDLIC_value_value,double,int,int,MDLIC_text_text,string,string,int,double,ENUM_BASE_CORNER,int,color,bool,bool,bool,bool,int,string>
{
	...
	virtual void _beforeExecute_()
	{
		ObjName = (string)v::BSSx;
		ObjectType = (ENUM_OBJECT)OBJ_TEXT;
		ObjCorner = (ENUM_BASE_CORNER)CORNER_LEFT_UPPER;
		ObjAnchor = (int)ANCHOR_CENTER;
		ObjColor = (color)c::BSS;
	}
};

// Block 27 (Formula)
class Block22: public MDL_Formula_10<MDLIC_value_value,double,string,MDLIC_market_point,double>
{
...
// Block 28 (Draw Fibonacci)
class Block23: public MDL_ChartDrawFibonacci<bool,bool,string,ENUM_OBJECT,MDLIC_value_time,datetime,MDLIC_value_value,double,MDLIC_value_time,datetime,MDLIC_value_value,double,MDLIC_value_time,datetime,MDLIC_candles_candles,double,bool,bool,bool,double,string,color,ENUM_LINE_STYLE,int,color,ENUM_LINE_STYLE,int,bool,bool,bool,bool,int,string>
{
...
/*<fxdreema:
:fxdreema>*/