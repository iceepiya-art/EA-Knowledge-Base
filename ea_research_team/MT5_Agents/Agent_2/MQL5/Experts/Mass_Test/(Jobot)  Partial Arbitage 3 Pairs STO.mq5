...
input double Lot_percent = 100.0;input double NEAR_PIP = 40.0;input double PercentProfit = 0.01;input string Symbol1 = "EURUSD";input string Symbol2 = "GBPUSD";input string Symbol3 = "EURGBP";input double STO_BUY_Level = 20.0;input double STO_SELL_Level = 80.0;input double STO_Period = 8.0;input int MagicStart = 9705; // Magic Number, kind of...
class c
{
		public:
	...
	static double STO_BUY_Level;
	static double STO_SELL_Level;
	static double STO_Period;
	static int MagicStart;
};
double c::Lot_percent;
double c::NEAR_PIP;
double c::PercentProfit;
string c::Symbol1;
string c::Symbol2;
string c::Symbol3;
double c::STO_BUY_Level;
double c::STO_SELL_Level;
double c::STO_Period;
int c::MagicStart;
...
int OnInit()
{
	...
	c::NEAR_PIP = NEAR_PIP;
	c::PercentProfit = PercentProfit;
	c::Symbol1 = Symbol1;
	c::Symbol2 = Symbol2;
	c::Symbol3 = Symbol3;
	c::STO_BUY_Level = STO_BUY_Level;
	c::STO_SELL_Level = STO_SELL_Level;
	c::STO_Period = STO_Period;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {4,6,10,14,16,18,20,22};
...
class Block0: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	{
		Symbol = (string)c::Symbol1;
		VolumePercent = (double)c::Lot_percent;
		ArrowColorBuy = (color)clrBlue;
	}
};

// Block 8 (Check profit (unrealized))
class Block1: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
class Block6: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 24 (Check profit (unrealized))
...
// Block 28 (Formula)
class Block10: public MDL_Formula_2<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 34 (STO)
class Block13: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
// Block 55 (STO)
class Block15: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
// Block 76 (STO)
class Block17: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
class Block18: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 97 (STO)
class Block19: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
// Block 98 (No position nearby)
class Block20: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 118 (STO)
class Block21: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
class Block22: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 139 (STO)
class Block23: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_value_value,double,int>
{
...
/*<fxdreema:
:fxdreema>*/