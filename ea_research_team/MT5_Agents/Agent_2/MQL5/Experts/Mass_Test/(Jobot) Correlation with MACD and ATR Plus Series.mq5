...
input string Symbol_1 = "EURUSD";input string Symbol_2 = "GBPUSD";input double MACD_Fast = 10.0;input double MACD_Slow = 200.0;input double ATR_Period = 200.0;input double LOT_Divided = 1000000.0;input double Martingale = 1.2;input bool Close_Profit_CCI_ON_OFF = true;input double Close_Profit_Percent = 0.01;input int MagicStart = 5681; // Magic Number, kind of...
class c
{
		public:
	static string Symbol_1;
	static string Symbol_2;
	static double MACD_Fast;
	static double MACD_Slow;
	static double ATR_Period;
	static double LOT_Divided;
	static double Martingale;
	static bool Close_Profit_CCI_ON_OFF;
	static double Close_Profit_Percent;
...
double c::Martingale;
bool c::Close_Profit_CCI_ON_OFF;
double c::Close_Profit_Percent;
int c::MagicStart;
...
int OnInit()
{
	...
	c::Close_Profit_CCI_ON_OFF = Close_Profit_CCI_ON_OFF;
	c::Close_Profit_Percent = Close_Profit_Percent;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {6,7,9,12,14,27,33};
	for (int i=0; i<ArraySize(blocks_to_run); i++) {
		_blocks_[blocks_to_run[i]].run();
	}
...
class MDL_Formula_4: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::Level1 = formula(compare, lo, ro);
...
class MDL_Formula_5: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::Level2 = formula(compare, lo, ro);
...
class MDL_Formula_7: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::First_Lot = formula(compare, lo, ro);
...
class Block0: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	{
		Symbol = (string)c::Symbol_2;
		VolumeSize = (double)v::LOT1;
		VolumePercent = (double)c::LOT_Divided;
		VolumeBlockPercent = (double)c::LOT_Divided;
		ArrowColorBuy = (color)clrBlue;
	}
};
...
// Block 11 (Buy now)
class Block2: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 15 (Close positions)
class Block4: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 17 (ON OFF)
class Block6: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
	...
	public: /* Custom methods */
	virtual bool _Lo_() {
		Lo.Boolean = c::Close_Profit_CCI_ON_OFF;
...
// Block 18 (ON OFF)
class Block7: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
...
// Block 20 (Check profit (unrealized))
...
// Block 21 (Formula)
class Block9: public MDL_Formula_1<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual double _Ro_() {
		Ro.Value = c::Close_Profit_Percent;
...
// Block 26 (Check profit (unrealized))
...
// Block 27 (Formula)
class Block12: public MDL_Formula_2<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 28 (Close positions)
class Block13: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 29 (Formula)
class Block14: public MDL_Formula_3<MDLIC_indicators_iMACD,double,string,MDLIC_indicators_iMACD,double>
{
	...
	Block14() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {16,18};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		compare = "-";
	}
	...
	public: /* Custom methods */
	virtual double _Lo_() {
		Lo.FastEMAperiod = c::MACD_Fast;
		Lo.SlowEMAperiod = c::MACD_Slow;
		Lo.AppliedPrice = PRICE_CLOSE;
		Lo.Symbol = c::Symbol_1;
		Lo.Period = CurrentTimeframe();

		return Lo._execute_();
	}
	virtual double _Ro_() {
		Ro.FastEMAperiod = c::MACD_Fast;
		Ro.SlowEMAperiod = c::MACD_Slow;
		Ro.AppliedPrice = PRICE_CLOSE;
		Ro.Symbol = c::Symbol_2;
...
class Block17: public MDL_ModifyVariables<int,MDLIC_indicators_iATR,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 34 (Position created)
class Block19: public MDL_eTrade_TradeNew<string,string,string,string,string>
{
...
// Block 35 (Formula)
class Block20: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_indicators_iATR,double>
{
...
// Block 36 (Position created)
class Block21: public MDL_eTrade_TradeNew<string,string,string,string,string>
{
...
// Block 37 (Formula)
class Block22: public MDL_Formula_5<MDLIC_value_value,double,string,MDLIC_indicators_iATR,double>
{
...
// Block 38 (Position closed)
class Block23: public MDL_eTrade_TradeClosed<string,string,string,string,string,string,int>
{
...
class Block24: public MDL_ModifyVariables<int,MDLIC_indicators_iATR,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block26: public MDL_ModifyVariables<int,MDLIC_indicators_iATR,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 42 (Formula)
class Block27: public MDL_Formula_6<MDLIC_indicators_iMACD,double,string,MDLIC_indicators_iMACD,double>
{
	...
	Block27() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {29,31};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		compare = "-";
	}
...
// Block 44 (No position)
class Block29: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
class Block30: public MDL_ModifyVariables<int,MDLIC_indicators_iATR,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 47 (Condition)
class Block32: public MDL_Condition<MDLIC_indicators_iMACD,double,string,MDLIC_indicators_iMACD,double,int>
{
...
// Block 50 (Formula)
class Block34: public MDL_Formula_7<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 52 (Formula)
class Block36: public MDL_Formula_8<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 54 (Formula)
class Block38: public MDL_Formula_9<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 55 (Formula)
class Block39: public MDL_Formula_10<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 56 (Formula)
class Block40: public MDL_Formula_11<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 57 (Formula)
class Block41: public MDL_Formula_12<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 58 (Condition)
class Block42: public MDL_Condition<MDLIC_indicators_iMACD,double,string,MDLIC_indicators_iMACD,double,int>
{
...
/*<fxdreema:
:fxdreema>*/