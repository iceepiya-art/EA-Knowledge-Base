...
input double NEAR_PIP = 20.0;
input double Profit_PIP = 10.0;
input double Loss_PIP = -8;
input int Number = 3;
input double Lot = 0.01;
input int MagicStart = 5947; // Magic Number, kind of...
class c
{
		public:
	static double NEAR_PIP;
	static double Profit_PIP;
	static double Loss_PIP;
	static int Number;
	static double Lot;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {0,2,10,21,32,34,38,39,40,42,44,54,56,63,65,82,83};
...
// Block 5 (Check trades count)
class Block4: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
// Block 8 (pips away from open-price)
class Block7: public MDL_LoopPipsAwayOP<string,int,int,string,double,double,MDLIC_value_value,double,MDLIC_value_value,double>
{
	...
	virtual void _beforeExecute_()
	{
		...
		PipsAway = (double)c::Loss_PIP;
	}
};

// Block 10 (Counter: Pass once)
class Block8: public MDL_PassOnce<int>
{
...
class Block9: public MDL_ModifyVariables<int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block11: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
// Block 14 (close)
class Block12: public MDL_LoopClose<ulong,color>
{
...
// Block 15 (Counter: Reset)
class Block13: public MDL_CounterReset<string>
{
...
// Block 20 (pips away from open-price)
class Block18: public MDL_LoopPipsAwayOP<string,int,int,string,double,double,MDLIC_value_value,double,MDLIC_value_value,double>
{
...
class Block19: public MDL_PassOnce<int>
{
	...
	Block19() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {20,73};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		CounterID = 2;
	}
...
class Block20: public MDL_ModifyVariables<int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
	...
	virtual void _beforeExecute_()
	{
		...
		v::Close_Sell = _Value1_();
	}
};

// Block 24 (Condition)
class Block21: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
// Block 26 (close)
class Block23: public MDL_LoopClose<ulong,color>
{
...
// Block 27 (Counter: Reset)
class Block24: public MDL_CounterReset<string>
{
...
// Block 30 (Check profit (unrealized))
class Block27: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 35 (once per trade/order)
class Block30: public MDL_LoopOncePer<bool>
{
...
class Block32: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
	...
	Block32() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {33,48};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		BuysOrSells = "buys";
	}
...
// Block 38 (Condition)
class Block33: public MDL_Condition<MDLIC_bucket_bucket_1,double,string,MDLIC_value_value,double,int>
{
...
class Block34: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
	...
	Block34() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {35,49};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		BuysOrSells = "sells";
	}
...
// Block 40 (Condition)
class Block35: public MDL_Condition<MDLIC_bucket_bucket_2,double,string,MDLIC_value_value,double,int>
{
...
// Block 56 (Bucket of Closed Trades)
class Block40: public MDL_BucketSelectClosed<color,string,string,string,string,string,bool,MDLIC_value_time,datetime,bool,MDLIC_value_time,datetime,int>
{
...
class Block41: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_3,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 58 (Bucket of Closed Trades)
class Block42: public MDL_BucketSelectClosed<color,string,string,string,string,string,bool,MDLIC_value_time,datetime,bool,MDLIC_value_time,datetime,int>
{
...
class Block43: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_4,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 61 (Comment)
class Block45: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_value_value,double,int,int,string,MDLIC_text_text,string,int,int>
{
...
// Block 64 (Condition)
class Block48: public MDL_Condition<MDLIC_bucket_bucket_5,double,string,MDLIC_value_value,double,int>
{
...
// Block 66 (Condition)
class Block49: public MDL_Condition<MDLIC_bucket_bucket_6,double,string,MDLIC_value_value,double,int>
{
...
// Block 68 (Formula)
class Block50: public MDL_Formula_1<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 69 (Formula)
class Block51: public MDL_Formula_2<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 70 (Counter: Pass once)
class Block52: public MDL_PassOnce<int>
{
...
// Block 71 (Counter: Pass once)
class Block53: public MDL_PassOnce<int>
{
...
// Block 72 (Bucket of Trades)
class Block54: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block55: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_7,double,int,MDLIC_bucket_bucket_8,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
	...
	virtual void _beforeExecute_()
	{
		...
		v::SellProfit = _Value1_();
		v::SellProfitCount = _Value2_();
	}
};

// Block 76 (For each Trade)
class Block56: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
class Block57: public MDL_ModifyVariables<int,MDLIC_inloop_OrderProfit,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block58: public MDL_CustomCode<bool>
{
	...
	virtual void _beforeExecute_()
	{
		...
		v::SUMSell = v::Accumulate + v::Sellx;
	}
};
...
// Block 81 (close)
class Block61: public MDL_LoopClose<ulong,color>
{
...
class Block62: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
	...
	virtual void _beforeExecute_()
	{
		...
		Symbol = (string)CurrentSymbol();
		LoopLimit = (int)v::SellProfitCount;
	}
};

// Block 84 (Bucket of Trades)
class Block63: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block64: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_9,double,int,MDLIC_bucket_bucket_10,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block66: public MDL_ModifyVariables<int,MDLIC_inloop_OrderProfit,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 93 (close)
class Block70: public MDL_LoopClose<ulong,color>
{
...
// Block 94 (For each Trade)
class Block71: public MDL_LoopStartTrades<string,string,string,string,string,string,int,int,int,int>
{
...
// Block 98 (Counter: Reset)
class Block72: public MDL_CounterReset<string>
{
...
// Block 100 (Formula)
class Block74: public MDL_Formula_3<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 101 (Formula)
class Block75: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 102 (Check trades count)
class Block76: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
// Block 114 (Check trades count)
class Block77: public MDL_CheckTradesCount<string,int,string,string,string,string,string>
{
...
// Block 117 (Check profit (unrealized))
class Block80: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 118 (Check profit (unrealized))
class Block81: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
...
// Block 121 (Custom MQL code)
class Block84: public MDL_CustomCode<bool>
{
...
// Block 122 (Custom MQL code)
class Block85: public MDL_CustomCode<bool>
{
...
class Block88: public MDL_PassOnce<int>
{
	...
	Block88() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {60,62,86};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		CounterID = 5;
	}
...
// Block 126 (Counter: Pass once)
class Block89: public MDL_PassOnce<int>
{
	...
	Block89() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {69,71,87};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		CounterID = 6;
	}
...
double OrderOpenPriceAsChild()
{
	...
	bool success = OrderSelect((int)originalTicket, SELECT_BY_TICKET, MODE_TRADES);
...
/*<fxdreema:
:fxdreema>*/
