...
int OnInit()
{
	...
	int disabled_blocks_list[] = {445,446,447,448,449};
...
// "Modify stops of positions" model
...
// Block 376 (Set \"Current Market\" for next blocks)
...
// Block 377 (Set \"Current Market\" for next blocks)
...
// Block 378 (Set \"Current Market\" for next blocks)
...
// Block 379 (Set \"Current Market\" for next blocks)
...
// Block 380 (Set \"Current Market\" for next blocks)
...
// Block 381 (Set \"Current Market\" for next blocks)
...
// Block 382 (Set \"Current Market\" for next blocks)
...
// Block 383 (Set \"Current Market\" for next blocks)
...
// Block 384 (Set \"Current Market\" for next blocks)
...
// Block 385 (Set \"Current Market\" for next blocks)
...
// Block 386 (Set \"Current Market\" for next blocks)
...
// Block 387 (Set \"Current Market\" for next blocks)
...
// Block 388 (Set \"Current Market\" for next blocks)
...
// Block 389 (Set \"Current Market\" for next blocks)
...
// Block 390 (Set \"Current Market\" for next blocks)
...
// Block 391 (Set \"Current Market\" for next blocks)
...
// Block 392 (Set \"Current Market\" for next blocks)
...
// Block 393 (Set \"Current Market\" for next blocks)
...
class Block444: public MDL_Pass
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[453].run(444);
		}
	}
};

// Block 450 (If position)
...
class Block446: public MDL_SetCurrentSymbol2<string>
{
	...
	Block446() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {445,448};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		ListOfSymbols = "AUDCAD, AUDCHF, AUDJPY, AUDNZD, AUDUSD, CADCHF, CADJPY, CHFJPY, EURAUD, EURCAD, EURCHF, EURGBP, EURJPY, EURNZD, EURUSD, GBPAUD, GBPCAD, GBPCHF, GBPJPY, GBPNZD, GBPUSD, NZDCAD, NZDCHF, NZDJPY, NZDUSD, USDCAD, USDCHF, USDJPY";
	}

	public: /* Callback & Run */
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[445].run(446);
			_blocks_[448].run(446);
		}
	}
};

// Block 453 (Modify stops of positions)
class Block447: public MDL_ModifyOpened<string,string,string,string,string,int,string,MDLIC_candles_candles,double,string,double,double,MDLIC_prices_LowestFromToCandles,double,double,double,MDLIC_value_value,double,color>
{
	...
	Block447() {
		...
		// IC input parameters
		fNewStopLoss.StartBar = 1;
		fNewTakeProfit.Value = 0.0;
		// Block input parameters
		BuysOrSells = "buys";
...
// Block 454 (If position)
class Block448: public MDL_IfOpenedOrders<string,string,string,string,string>
{
...
// Block 457 (Modify stops of positions)
class Block449: public MDL_ModifyOpened<string,string,string,string,string,int,string,MDLIC_candles_candles,double,string,double,double,MDLIC_prices_HighestFromToCandles,double,double,double,MDLIC_value_value,double,color>
{
...
// Block 458 (Once per bar)
class Block450: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
...
// Block 459 (Once per bar)
class Block451: public MDL_OncePerBar<string,ENUM_TIMEFRAMES,int>
{
...
// Block 460 (Close positions)
class Block452: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 461 (Close positions)
class Block453: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 462 (No position nearby)
class Block454: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 463 (No position nearby)
class Block455: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
/*<fxdreema:
:fxdreema>*/