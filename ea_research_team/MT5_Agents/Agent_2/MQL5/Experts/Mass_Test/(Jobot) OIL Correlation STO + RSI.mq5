...
input string OIL_UK = "XBRUSD";input string OIL_US = "XTIUSD";input double DIF_STO = 20.0;input double STO_K = 5.0;input double STO_D = 3.0;input double STO_Slow = 3.0;input double LOT = 1.0;input double Near_PIP = 40.0;input bool Close_Profit_RSI_ON_OFF = true;input bool Close_Profit_Dollar_ON_OFF = true;input double Close_Profit_Dollar = 10.0;input int MagicStart = 5681; // Magic Number, kind of...
class c
{
		public:
	static string OIL_UK;
	static string OIL_US;
	static double DIF_STO;
	static double STO_K;
	static double STO_D;
	static double STO_Slow;
	static double LOT;
	static double Near_PIP;
	static bool Close_Profit_RSI_ON_OFF;
	static bool Close_Profit_Dollar_ON_OFF;
	static double Close_Profit_Dollar;
...
double c::LOT;
double c::Near_PIP;
bool c::Close_Profit_RSI_ON_OFF;
bool c::Close_Profit_Dollar_ON_OFF;
double c::Close_Profit_Dollar;
int c::MagicStart;
...
int OnInit()
{
	...
	c::LOT = LOT;
	c::Near_PIP = Near_PIP;
	c::Close_Profit_RSI_ON_OFF = Close_Profit_RSI_ON_OFF;
	c::Close_Profit_Dollar_ON_OFF = Close_Profit_Dollar_ON_OFF;
	c::Close_Profit_Dollar = Close_Profit_Dollar;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {1,6,14,15,16,22};
...
// Block 1 (Condition)
class Block0: public MDL_Condition<MDLIC_indicators_iRSI,double,string,MDLIC_indicators_iRSI,double,int>
{
...
// Block 2 (Formula)
class Block1: public MDL_Formula_1<MDLIC_indicators_iStochastic,double,string,MDLIC_indicators_iStochastic,double>
{
...
// Block 5 (Buy now)
class Block3: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 7 (Condition)
class Block5: public MDL_Condition<MDLIC_indicators_iRSI,double,string,MDLIC_indicators_iRSI,double,int>
{
...
// Block 8 (Formula)
class Block6: public MDL_Formula_2<MDLIC_indicators_iStochastic,double,string,MDLIC_indicators_iStochastic,double>
{
...
// Block 9 (Condition)
class Block7: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
// Block 14 (Condition)
class Block11: public MDL_Condition<MDLIC_indicators_iStochastic,double,string,MDLIC_indicators_iStochastic,double,int>
{
...
// Block 17 (ON OFF)
class Block14: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
	...
	public: /* Custom methods */
	virtual bool _Lo_() {
		Lo.Boolean = c::Close_Profit_RSI_ON_OFF;
...
class Block17: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		ProfitAmount = (double)c::Close_Profit_Dollar;
	}
};

// Block 21 (Formula)
class Block18: public MDL_Formula_3<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	virtual double _Ro_() {
		Ro.Value = c::Close_Profit_Dollar;
...
// Block 24 (No position nearby)
class Block21: public MDL_NoNearbyRunning<string,string,string,string,string,MDLIC_value_time,datetime,MDLIC_value_time,datetime,string,MDLIC_prices_prices,double,string,double,double,int>
{
...
// Block 27 (Formula)
class Block24: public MDL_Formula_4<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
class Block25: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
/*<fxdreema:
:fxdreema>*/