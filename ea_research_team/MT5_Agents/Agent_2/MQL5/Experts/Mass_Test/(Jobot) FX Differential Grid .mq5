...
//+------------------------------------------------------------------------------+//
#property copyright   "Jobot EA FOREX"
...
input string _1_Symbol = "EURUSD";input string _2_Symbol = "GBPUSD";input string ____SPREAD_SETTING____ = "=====================";input double LOT_Divided = 100000.0;input double Distance_Spread_Next_Trades = 0.002;input double Take_Profit_Spread = 100.0;input bool Close_All = true;input double Close_All_Profit_Percent = 1.0;input double Money_All = 1.0;input bool Cut_Loss = true;input double Cut_Loss_Percent = 30.0;input string ____DISPLAY_SETTING____ = "=====================";input bool Show_Count_Orders = true;input bool Show_High_Low_Spread = true;input string Comment_A = "A_FX_JOBOT_";input string Comment_B = "B_FX_JOBOT_";input int MagicStart = 39995; // Magic Number, kind of...
class c
{
		public:
	static string _1_Symbol;
	static string _2_Symbol;
	static string ____SPREAD_SETTING____;
	static double LOT_Divided;
	static double Distance_Spread_Next_Trades;
	static double Take_Profit_Spread;
...
class v
{
	...
	static double SPNBH;
	static double SPNBL;
	static double initiallot;
	static double Profitxxx;
	static double BalanceX;
	static double PercentX;
	static double cutpercent;
};
double v::SpreadX;
double v::XTI;
double v::XBR;
...
int OnInit()
{
	...
	// Initiate Constants
	c::_1_Symbol = _1_Symbol;
	c::_2_Symbol = _2_Symbol;
	...
	c::Take_Profit_Spread = Take_Profit_Spread;
	c::Close_All = Close_All;
	c::Close_All_Profit_Percent = Close_All_Profit_Percent;
	c::Money_All = Money_All;
	c::Cut_Loss = Cut_Loss;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {0,2,21,23,42,43,44,45,55,95,97,99,101,103,105,108,111,114,125,127,134,135,140};
	for (int i=0; i<ArraySize(blocks_to_run); i++) {
		_blocks_[blocks_to_run[i]].run();
	}
...
class MDL_Formula_22: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::LotSumProA = formula(compare, lo, ro);
...
class MDL_Formula_24: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::LotSumProB = formula(compare, lo, ro);
...
class MDL_Formula_27: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::initiallot = formula(compare, lo, ro);
...
class MDL_Formula_28: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::BalanceX = formula(compare, lo, ro);
...
class MDL_Formula_32: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::Profitxxx = formula(compare, lo, ro)/100;
...
class MDL_Formula_33: public BlockCalls
{
	...
	virtual void _execute_()
	{
		...
		v::cutpercent = formula(compare, lo, ro)/100;
...
class Block6: public MDL_ModifyVariables<int,MDLIC_inloop_OrderOpenPrice,double,int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 8 (Modify Variables)
class Block7: public MDL_ModifyVariables<int,MDLIC_inloop_OrderOpenPrice,double,int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
class Block9: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
	...
	virtual void _beforeExecute_()
	{
		Group = (string)v::N;
		Symbol = (string)c::_1_Symbol;
		VolumeSize = (double)v::initiallot;
...
// Block 12 (No trade)
class Block11: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 13 (No trade)
class Block12: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 15 (Comment)
class Block14: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_account_AccountEquity,double,string,MDLIC_account_AccountProfit,double>
{
...
// Block 20 (Close positions)
class Block19: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 21 (Formula)
class Block20: public MDL_Formula_3<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block27: public MDL_ModifyVariables<int,MDLIC_inloop_OrderOpenPrice,double,int,MDLIC_inloop_OrderVolume,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 31 (Condition)
class Block29: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
// Block 36 (Formula)
class Block34: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 37 (Formula)
class Block35: public MDL_Formula_5<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 41 (Close positions)
class Block39: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 42 (Formula)
class Block40: public MDL_Formula_6<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 45 (Condition)
class Block42: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
class Block45: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
	...
	Block45() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[4] = {51,53,56,59};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		compare = "==";
	}
...
// Block 49 (Formula)
class Block46: public MDL_Formula_7<MDLIC_text_text,string,string,MDLIC_text_text,string>
{
...
// Block 50 (Formula)
class Block47: public MDL_Formula_8<MDLIC_text_text,string,string,MDLIC_text_text,string>
{
...
// Block 51 (Modify chart colors)
class Block48: public MDL_ChartSetColors<color,color,color,color,color,color,color,color,color,color,color,color,color>
{
...
class Block49: public MDL_Pass
{
	...
	Block49() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {48,50};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 53 (Modify chart properties)
class Block50: public MDL_ChartSetProperties<int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int>
{
...
class Block55: public MDL_Pass
{
	...
	Block55() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {70,72};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 61 (Modify Variables)
class Block58: public MDL_ModifyVariables<int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 63 (No trade)
class Block60: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 65 (Formula)
class Block62: public MDL_Formula_9<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 66 (Formula)
class Block63: public MDL_Formula_10<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
	...
	public: /* Custom methods */
	virtual double _Lo_() {
		Lo.Symbol = c::_2_Symbol;

		return Lo._execute_();
	}
	virtual double _Ro_() {
		Ro.Symbol = c::_1_Symbol;
...
// Block 67 (Formula)
class Block64: public MDL_Formula_11<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 68 (Formula)
class Block65: public MDL_Formula_12<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 69 (Formula)
class Block66: public MDL_Formula_13<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 70 (Formula)
class Block67: public MDL_Formula_14<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 71 (Comment)
class Block68: public MDL_CommentEx<string,string,int,int,int,string,color,int,string,color,int,string,color,int,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_value_value,double,string,MDLIC_text_text,string,string,MDLIC_text_text,string>
{
	...
	Block68() {
		...
		Value8.Text = "";
		// Block input parameters
		Title = "(Jobot) FX Differential Grid";
		Label1 = "A Spread NOW";
		Label2 = "A HIGH";
		Label3 = "A LOW";
		Label4 = "B Spread NOW";
...
// Block 73 (Formula)
class Block70: public MDL_Formula_16<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 74 (Formula)
class Block71: public MDL_Formula_17<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 75 (Formula)
class Block72: public MDL_Formula_18<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 76 (Formula)
class Block73: public MDL_Formula_19<MDLIC_prices_prices,double,string,MDLIC_prices_prices,double>
{
...
// Block 77 (Formula)
class Block74: public MDL_Formula_20<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 79 (Bucket of Positions)
class Block76: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block77: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_1,double,int,MDLIC_bucket_bucket_2,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 81 (Formula)
class Block78: public MDL_Formula_21<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 82 (Formula)
class Block79: public MDL_Formula_22<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
	...
	public: /* Custom methods */
	virtual double _Lo_() {
		Lo.Value = v::initiallot;

		return Lo._execute_();
	}
	virtual double _Ro_() {
		Ro.Value = c::Take_Profit_Spread;
...
class Block80: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	Block80() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {18,19,20};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 85 (Bucket of Positions)
class Block82: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block83: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_3,double,int,MDLIC_bucket_bucket_4,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 87 (Formula)
class Block84: public MDL_Formula_23<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 88 (Formula)
class Block85: public MDL_Formula_24<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
class Block86: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	Block86() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[3] = {38,39,40};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
	}
...
// Block 90 (Bucket of Positions)
class Block87: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 91 (Bucket of Positions)
class Block88: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 92 (Modify Variables)
class Block89: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_5,double,int,MDLIC_bucket_bucket_6,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 93 (Formula)
class Block90: public MDL_Formula_25<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 96 (Modify Variables)
class Block93: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_7,double,int,MDLIC_bucket_bucket_8,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 97 (Formula)
class Block94: public MDL_Formula_26<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 98 (Once a day)
class Block95: public MDL_OnceAday<string,string,string,string,string>
{
...
// Block 100 (Condition)
class Block97: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
...
class Block107: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_9,double,int,MDLIC_bucket_bucket_10,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 112 (Bucket of Positions)
class Block109: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
class Block110: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_11,double,int,MDLIC_bucket_bucket_12,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 115 (Bucket of Positions)
class Block112: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 121 (Bucket of Positions)
class Block115: public MDL_BucketSelectOpened<color,string,string,string,string,string>
{
...
// Block 122 (Modify Variables)
class Block116: public MDL_ModifyVariables<int,MDLIC_bucket_bucket_15,double,int,MDLIC_bucket_bucket_16,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 126 (No trade)
class Block117: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 127 (No trade)
class Block118: public MDL_NoOpenedOrders<string,string,string,string,string>
{
	...
	Block118() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {119,120};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "A";
		BuysOrSells = "sells";
...
// Block 128 (Buy now)
class Block119: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 130 (No trade)
class Block121: public MDL_NoOpenedOrders<string,string,string,string,string>
{
...
// Block 131 (No trade)
class Block122: public MDL_NoOpenedOrders<string,string,string,string,string>
{
	...
	Block122() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {123,124};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		Group = "B";
		BuysOrSells = "buys";
...
// Block 132 (Buy now)
class Block123: public MDL_BuyNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 133 (Sell now)
class Block124: public MDL_SellNow<string,string,string,double,double,double,double,double,MDLIC_value_value,double,double,double,double,double,double,double,double,int,int,double,bool,double,double,bool,double,string,bool,double,string,string,bool,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,double,double,double,MDLIC_value_value,double,MDLIC_value_value,double,MDLIC_value_value,double,string,int,int,int,MDLIC_value_time,datetime,ulong,string,color>
{
...
// Block 134 (Formula)
class Block125: public MDL_Formula_27<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
	...
	Block125() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {117,121};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		compare = "/";
	}
...
// Block 135 (Condition)
class Block126: public MDL_Condition<MDLIC_account_AccountEquity,double,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[130].run(126);
		}
	}
};

// Block 136 (Counter: Pass once)
class Block127: public MDL_PassOnce<int>
{
...
class Block128: public MDL_ModifyVariables<int,MDLIC_account_AccountBalance,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double,int,MDLIC_value_value,double>
{
...
// Block 138 (Formula)
class Block129: public MDL_Formula_28<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
class Block130: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
	...
	Block130() {
		...
		// Fill the list of outbound blocks
		int ___outbound_blocks[2] = {133,136};
		ArrayCopy(__outbound_blocks, ___outbound_blocks);
		// Block input parameters
		GroupMode = "all";
		SymbolMode = "all";
...
// Block 146 (Formula)
class Block132: public MDL_Formula_30<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 153 (Formula)
class Block133: public MDL_Formula_31<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
// Block 154 (Condition)
class Block134: public MDL_Condition<MDLIC_value_value,double,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[126].run(134);
		}
	}
};

// Block 155 (Condition)
class Block135: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
...
// Block 450 (Check profit (unrealized))
class Block137: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		ProfitAmount = (double)v::Profitxxx;
	}
};

// Block 451 (Close positions)
class Block138: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 452 (Formula)
class Block139: public MDL_Formula_32<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
class Block140: public MDL_Condition<MDLIC_boolean_boolean,bool,string,MDLIC_value_value,double,int>
{
	...
	virtual void _callback_(int value) {
		if (value == 1) {
			_blocks_[144].run(140);
		}
	}
};

// Block 556 (Modify Variables)
...
// Block 748 (Check profit (unrealized))
class Block142: public MDL_CheckUProfit<string,string,string,string,string,string,string,double,double,string,string,double,double>
{
	...
	{
		Symbol = (string)CurrentSymbol();
		ProfitAmount = (double)v::cutpercent;
	}
};

// Block 749 (Close positions)
class Block143: public MDL_CloseOpened<string,string,string,string,string,int,ulong,color>
{
...
// Block 750 (Formula)
class Block144: public MDL_Formula_33<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/