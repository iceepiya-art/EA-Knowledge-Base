...
input string Symbol_1 = "EURUSD";input string Symbol_2 = "GBPUSD";input double CCI_Period = 200.0;input double CCI_DIF_Start = 50.0;input double CCI_DIF_Step = 50.0;input double LOT_Divided = 100000.0;input double Martingale = 1.2;input bool Close_Profit_CCI_ON_OFF = true;input double Close_Profit_Percent = 0.1;input int MagicStart = 5681; // Magic Number, kind of...
class c
{
		public:
	static string Symbol_1;
	static string Symbol_2;
	static double CCI_Period;
	static double CCI_DIF_Start;
	static double CCI_DIF_Step;
...
string c::Symbol_2;
double c::CCI_Period;
double c::CCI_DIF_Start;
double c::CCI_DIF_Step;
...
int OnInit()
{
	...
	c::Symbol_1 = Symbol_1;
	c::Symbol_2 = Symbol_2;
	c::CCI_Period = CCI_Period;
	c::CCI_DIF_Start = CCI_DIF_Start;
	c::CCI_DIF_Step = CCI_DIF_Step;
...
void OnTick()
{
	...
	//-- run blocks
	int blocks_to_run[] = {6,7,9,12,14,27,34};
	for (int i=0; i<ArraySize(blocks_to_run); i++) {
		_blocks_[blocks_to_run[i]].run();
	}
...
// Block 29 (Formula)
class Block14: public MDL_Formula_3<MDLIC_indicators_iCCI,double,string,MDLIC_indicators_iCCI,double>
{
...
// Block 35 (Formula)
class Block20: public MDL_Formula_4<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 37 (Formula)
class Block22: public MDL_Formula_5<MDLIC_value_value,double,string,MDLIC_value_value,double>
{
...
// Block 42 (Formula)
class Block27: public MDL_Formula_6<MDLIC_indicators_iCCI,double,string,MDLIC_indicators_iCCI,double>
{
...
// Block 47 (Condition)
class Block32: public MDL_Condition<MDLIC_indicators_iCCI,double,string,MDLIC_indicators_iCCI,double,int>
{
...
// Block 48 (Condition)
class Block33: public MDL_Condition<MDLIC_indicators_iCCI,double,string,MDLIC_indicators_iCCI,double,int>
{
...
// Block 50 (Formula)
class Block35: public MDL_Formula_7<MDLIC_account_AccountBalance,double,string,MDLIC_value_value,double>
{
...
/*<fxdreema:
:fxdreema>*/