...
ini_path = Path(r"C:\Users\ADMIN\AppData\Roaming\MetaQuotes\Terminal\81A933A9AFC5DE3C23B15CAB19C63850\MQL5\Experts\backtest_master_100.ini")
...
if log_files:
    ...
    print(f"\n[!!!] 100 USD BACKTEST RESULTS -> Final Balance:  | Total Deals: {trades}")
else:
    print("[-] No logs found.")
