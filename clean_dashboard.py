...
def clean_dashboard():
    ...
    # We delete everything from start_idx to body_end_idx
    # This guarantees no garbage or duplicate scripts are left behind
    ...
    # We replace from start_idx up to body_end_idx
    # So we must append </body> back!
    new_html = html[:start_idx] + clean_html + "\n</body>" + html[body_end_idx+7:]
    dashboard_path.write_text(new_html, encoding="utf-8")
    print("Dashboard hard reset and cleaned successfully.")
